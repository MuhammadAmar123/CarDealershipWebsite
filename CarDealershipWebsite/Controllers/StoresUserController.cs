...
{
    public class StoresUserController : Controller
    {
        private readonly CarDealershipWebsiteContext _context;

        public StoresUserController(CarDealershipWebsiteContext context)
        {
            _context = context;
        }
        ...
        // GET: StoresUser/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: StoresUser/Create
